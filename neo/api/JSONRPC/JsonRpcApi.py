...
from neocore.Core.TX.Transaction import Transaction, TransactionOutput, \
    ContractTransaction, TXFeeError
from neocore.Core.TX.TransactionAttribute import TransactionAttribute, \
...
from neocore.Core.VM import VMStateStr
